(function (factory) {
  ...
  var HMS = /*#__PURE__*/Object.freeze({
    ...
    HLSPlaylistType: Vs,
    HLSStreamType: Fs,
    HMSAudioDeviceCategory: _r,
    HMSAudioMode: wr,
    HMSAudioPluginType: Cr,
    HMSLogLevel: ks,
    HMSMessageType: So,
    HMSNotificationSeverity: fs,
    HMSNotificationTypes: Pr,
    HMSPeerType: Dr,
    HMSPlaylistType: vs,
    HMSPluginUnsupportedTypes: Lr,
    HMSReactiveStore: mt,
    HMSRecordingState: Bs,
    HMSRoomState: Er,
    HMSStats: si,
    HMSTrackExceptionTrackType: Ds,
    HMSTranscriptionMode: Ws,
    HMSTranscriptionState: Gs,
    HMSVideoPluginCanvasContextType: Wr,
    HMSVideoPluginType: Gr,
    createDefaultStatsStore: ni,
    createDefaultStoreState: oi,
    getAudioDeviceCategory: Nr,
    parsedUserAgent: fe,
    selectAppData: mS,
    selectAppDataByPath: gS,
    selectAudioPlaylist: Aa,
    selectAudioPlaylistTrackByPeerID: CS,
    selectAudioTrackByID: vS,
    selectAudioTrackByPeerID: on,
    selectAudioTrackVolume: _a,
    selectAudioVolumeByPeerID: OS,
    selectAuxiliaryAudioByPeerID: IS,
    selectAuxiliaryTracksByPeerID: ES,
    selectAvailableRoleNames: Fm,
    selectBroadcastMessages: cn,
    selectBroadcastMessagesUnreadCount: BS,
    selectCameraStreamByPeerID: kS,
    selectConnectionQualities: Em,
    selectConnectionQualityByPeerID: AS,
    selectDegradedTracks: Nm,
    selectDevices: km,
    selectDidIJoinWithin: mg,
    selectDominantSpeaker: Rm,
    selectEffectsKey: Xm,
    selectErrors: Go,
    selectFullAppData: zr,
    selectHLSState: Km,
    selectHMSBroadcastMessages: Jo,
    selectHMSMessages: Dt,
    selectHMSMessagesCount: Om,
    selectHMSStats: oc,
    selectHandRaisedPeers: iS,
    selectHasPeerHandRaised: jS,
    selectIsAllowedToPreviewMedia: sg,
    selectIsAllowedToPublish: rg,
    selectIsAllowedToSubscribe: Gm,
    selectIsAudioLocallyMuted: wa,
    selectIsConnectedToRoom: Be,
    selectIsEffectsEnabled: zm,
    selectIsInPreview: ma,
    selectIsLargeRoom: Qm,
    selectIsLocalAudioEnabled: Hm,
    selectIsLocalAudioPluginPresent: ug,
    selectIsLocalScreenShared: Xr,
    selectIsLocalVideoDisplayEnabled: ha,
    selectIsLocalVideoEnabled: Yr,
    selectIsLocalVideoPluginPresent: lg,
    selectIsLocallyMutedByPeerID: _S,
    selectIsPeerAudioEnabled: DS,
    selectIsPeerVideoEnabled: wS,
    selectIsRoleAllowedToPublish: dg,
    selectIsScreenShareLocallyMutedByPeerID: NS,
    selectIsSomeoneScreenSharing: Cm,
    selectIsTranscriptionAllowedByMode: zS,
    selectIsTranscriptionEnabled: Vm,
    selectIsVBEnabled: Ym,
    selectLocalAudioTrackID: le,
    selectLocalMediaSettings: ua,
    selectLocalPeer: re,
    selectLocalPeerID: Ie,
    selectLocalPeerName: bm,
    selectLocalPeerRole: ct,
    selectLocalPeerRoleName: Am,
    selectLocalTrackIDs: pa,
    selectLocalVideoTrackID: Z,
    selectMessageByMessageID: QS,
    selectMessageIDsInOrder: la,
    selectMessagesByPeerID: VS,
    selectMessagesByRole: FS,
    selectMessagesMap: Ai,
    selectMessagesUnreadCountByPeerID: WS,
    selectMessagesUnreadCountByRole: GS,
    selectPeerAudioByID: bS,
    selectPeerByCondition: pg,
    selectPeerByID: ee,
    selectPeerCount: Pm,
    selectPeerMetadata: qS,
    selectPeerName: JS,
    selectPeerNameByID: TS,
    selectPeerScreenSharing: jo,
    selectPeerSharingAudio: Lm,
    selectPeerSharingAudioPlaylist: _m,
    selectPeerSharingVideoPlaylist: wm,
    selectPeerTypeByID: fS,
    selectPeers: Ee,
    selectPeersByCondition: hg,
    selectPeersByRole: $S,
    selectPeersByRoles: KS,
    selectPeersMap: z,
    selectPeersScreenSharing: Dm,
    selectPeersWithAudioStatus: tg,
    selectPermissions: ga,
    selectPollByID: xa,
    selectPolls: tS,
    selectPollsMap: Ta,
    selectPreviewRole: Sa,
    selectPreviewRoleName: Qo,
    selectRTMPState: $m,
    selectRecentError: Mm,
    selectRecordingState: Wm,
    selectRemotePeers: Im,
    selectRoleByRoleName: pn,
    selectRoleChangeRequest: ig,
    selectRolesMap: Pe,
    selectRoom: F,
    selectRoomID: ym,
    selectRoomStartTime: Jm,
    selectRoomStarted: Bm,
    selectRoomState: se,
    selectScreenAudioTrackByID: MS,
    selectScreenShareAudioByPeerID: Da,
    selectScreenShareByPeerID: LS,
    selectScreenSharesByPeerId: La,
    selectScreenVideoTrackByID: yS,
    selectScreenshareAudioVolumeByPeerID: xS,
    selectSessionId: jm,
    selectSessionMetadata: eS,
    selectSessionStore: SS,
    selectSimulcastLayerByTrack: US,
    selectSpeakers: Wo,
    selectTemplateAppData: Zm,
    selectTrackAudioByID: PS,
    selectTrackByID: Ii,
    selectTracksMap: N,
    selectTranscriptionsState: qm,
    selectUnreadHMSBroadcastMessagesCount: Um,
    selectUnreadHMSMessagesCount: xm,
    selectVideoPlaylist: Ia,
    selectVideoPlaylistAudioTrackByPeerID: HS,
    selectVideoPlaylistVideoTrackByPeerID: RS,
    selectVideoTrackByID: Ha,
    selectVideoTrackByPeerID: an,
    selectWhiteboard: rS,
    selectWhiteboards: zo,
    simulcastMapping: We
  });

  // Expose a minimal API to window that Flutter's custom JS (or your web-layer) can use.
  // We import the modern package and attach what you need to window.HMSBundle.

  // Expose the imported modules under window.HMSBundle
  // (You can expand the object to add helpers you need later)
  window.HMSBundle = {
    raw: HMS,
    // example helper: returns the store factory if needed
    createStore: (opts = {}) => {
      // Some apps use HMS.HMSReactiveStore or similar — expose raw for flexibility.
      return HMS;
    }
  };
